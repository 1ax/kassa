...
def ffd():
    ...
    def read(k):
        ...
        steps = [
            ...
            {
                "key": "settlement",
                "title": "Снять отчёт о состоянии расчётов",
                "state": "manual",
                "note": (
                    "Кнопкой «Отчёт о состоянии расчётов» на панели "
                    "обслуживания; программа не знает, снят ли он — отметки "
                    "нигде не хранятся."
                ),
            },
            {
                "key": "firmware",
                "title": "Обновить прошивку ККТ с автоперерегистрацией на 1.2",
                "state": (
                ...
                "note": (
                    ...
                    "в утилите Штрих-М ДО обновления прошивки."
                ),
            },
            {
                "key": "table19",
                ...
                "state": "manual",
                "note": "Параметры берутся у своего ОФД; программа таблицы не читает.",
            },
            {
                "key": "lk_fns",
