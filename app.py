        ...
        steps = [
            ...
            },
            {
                ...
                "note": (
                    ...
                    "партнёров Штрих-М; сборка требует подписки на квартал, "
                    "в котором она выпущена. Смотреть в Тесте Драйвера, "
                    "раздел функциональных лицензий: протоколом подписка "
                    "не читается — на 1Dh эта прошивка отвечает отказом."
                ),
            },
            {
                "key": "shift",
